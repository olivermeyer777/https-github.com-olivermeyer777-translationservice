...
function SessionView({ 
    ...
    const { 
        ...
        error, 
        transcripts 
    } = useGeminiTranslator({ userLanguage: myLanguage, targetLanguage: targetLanguage });
    ...
    return (
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden h-screen relative bg-gray-900">
            ...
            {/* Right: Smart Transcript (Chat Style) */}
            <div className="w-full lg:w-[420px] bg-white border-l border-gray-200 flex flex-col z-20 shadow-2xl h-1/2 lg:h-full">
                {/* Header */}
                <div className="p-6 border-b border-gray-100 bg-white/95 backdrop-blur flex-shrink-0">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="p-1.5 bg-blue-50 rounded-lg text-blue-600">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                  <path fillRule="evenodd" d="M10 2c-2.236 0-4.43.18-6.57.524C1.993 2.755 1 4.014 1 5.426v5.148c0 1.413.993 2.67 2.43 2.902 1.168.188 2.352.327 3.57.414v3.027a1 1 0 0 0 1.638.774l2.97-2.484a57.41 57.41 0 0 0 5.963-.728c1.437-.232 2.429-1.49 2.429-2.902V5.426c0-1.413-.992-2.67-2.429-2.902A58.35 58.35 0 0 0 10 2Z" clipRule="evenodd" />
                                </svg>
                            </div>
                    ...
                    <div className="flex items-center justify-between text-sm bg-slate-50 p-4 rounded-xl border border-slate-100 shadow-inner">
                         <div className="flex flex-col items-center">
                            <span className="text-2xl mb-1">{myLanguage.flag}</span>
                         ...
                         <div className="flex-1 px-4 flex flex-col items-center">
                             ...
                             <div className="bg-white border border-blue-100 text-blue-600 text-[10px] font-bold px-2 py-0.5 rounded-full relative z-10 shadow-sm">
                                 TRANSLATING
                             </div>
                         </div>

                         <div className="flex flex-col items-center">
                            <span className="text-2xl mb-1">{targetLanguage.flag}</span>
                            <span className="text-[10px] font-bold text-gray-400 tracking-wide">REMOTE</span>
                         </div>
                    </div>
                </div>
                ...
                >
                    ...
                    {transcripts.length === 0 && !error && (
                        <div className="flex flex-col items-center justify-center h-full text-center text-gray-400 px-8">
                             <div className="w-12 h-12 rounded-full bg-white border border-dashed border-gray-300 flex items-center justify-center mb-3">
                    ...
                    {transcripts.map((t) => (
                        <div key={t.id} className={`flex flex-col ${t.isUser ? 'items-end' : 'items-start'} animate-fade-in`}>
                            <div className={`
